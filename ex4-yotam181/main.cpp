...
/**
 * Given a binary file path and a _data,
 * reads the content of the file into the _data.
 * file must match _data in size in order to read successfully.
 * @param filePath - path of the binary file to read
 * @param mat -  _data to read the file into.
 ...
 *        path.
 * @param weights array of _data, weigths[i] is the i'th layer weights _data
 * @param biases array of _data, biases[i] is the i'th layer bias _data
